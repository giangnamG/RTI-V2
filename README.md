...
**Ví dụ với Ports** (history drawer nhóm theo phiên scan):

| Phiên | Host | IP | Port | Service | Thời điểm |
|-------|------|----|------|---------|-----------|
| T1 | admin-partner.vnpay.vn | 103.220.86.209 | 80, 443 | http, https | 27/6/2026 |
| T2 | admin-partner.vnpay.vn | 103.220.86.209 | 80, 443, 8443 | http, https, https-alt | 30/6/2026 |

→ Giao diện (latest view) hiển thị 3 ports từ T2. Click vào host → drawer hiện 2 phiên scan T1 và T2.
